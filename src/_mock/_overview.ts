...
export const _appFeatured = [
  {
    id: '1',
    title: 'Đặt lịch khám dễ dàng, nhanh chóng',
    description:
  ...
  {
    id: '2',
    title: 'Tư vấn sức khỏe cùng bác sĩ uy tín',
    description:
      'Đội ngũ bác sĩ có chuyên môn cao, nhiều năm kinh nghiệm sẵn sàng đồng hành cùng bạn.',
    coverUrl:
      'https://res.cloudinary.com/dut4zlbui/image/upload/v1743433538/sh5zkgwit4wlfkqkqsgd.jpg'
  },
  {
    id: '3',
    title: 'Quản lý hồ sơ bệnh án thông minh',
    description:
      'Lưu trữ, tra cứu, và chia sẻ hồ sơ y tế dễ dàng trên một nền tảng bảo mật tuyệt đối.',
    coverUrl:
      'https://res.cloudinary.com/dut4zlbui/image/upload/v1742739624/klp4ifzgckkmhcxtyuab.png'
  }
]
