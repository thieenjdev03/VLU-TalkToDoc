...
export const paths = {
  ...
  dashboard: {
    ...
    specialties: {
      ...
      list: `${ROOTS.DASHBOARD}/specialties/list`,
      details: (id: string) => `${ROOTS.DASHBOARD}/specialties/${id}`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/specialties/${id}/edit`,
    },
    ...
    user: {
      ...
      list_employee: `${ROOTS.DASHBOARD}/user/list-employee`,
      list_patient: `${ROOTS.DASHBOARD}/user/list-patient`,
      list: `${ROOTS.DASHBOARD}/user/list`,
      new_doctor: `${ROOTS.DASHBOARD}/user/new-doctor`,
      new_employee: `${ROOTS.DASHBOARD}/user/new-employee`,
      new_patient: `${ROOTS.DASHBOARD}/user/new-patient`,
