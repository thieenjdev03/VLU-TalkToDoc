    ...
    <div className="-mx-4 flex flex-wrap mb-10">
      <div className="w-full px-4 text-center">
        ...
        <p className="text-base text-body-color">
          TalkToDoc áp dụng mô hình chi phí linh hoạt: bạn chỉ cần trả phí nền tảng cố định cộng với
          giá khám được bác sĩ đặt theo cấp bậc chuyên môn.
        </p>
      </div>
    </div>
